...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%  
   		...
   		String sql="select a.*,b.* from student a,message b where a.sno=b.stuid and teachername=?";
...
<script>
		...
		function check(){
			//后续查询做相应的修改
			window.location.href="#.jsp?action=search&text="+text;
		}
</script>
<body>
          ...
          <tr>
			...
			<!-- 列表 start -->
          	...
          	<tbody>
				...
				%></td>
				<td>
	        	<a href="showreceive.jsp?messageid=<%=d.get("messageid")%>">查看详情</a><b>|</b>
