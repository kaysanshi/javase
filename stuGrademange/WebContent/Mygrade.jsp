...
<script>
		...
		function check(){
			...
			//后续查询做相应的修改
			window.location.href="MylistGrade.jsp?action=search&text="+text;
		}
</script>
<body>
...
<tr>
    ...
    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="images/left_topbg" id="table2">
     <tbody><tr>
        <td height="31"><div class="titlebt">我的成绩</div></td>
      </tr>
    </tbody>
	</table>
    </td>
    ...
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<!-- 查询条件 start-->
          	...
          	<tbody><tr>
          	<td width="50">查询条件</td>
          	<td>课程：<input name="queryCondition.username" type="text" id="textname" value=""> </td>
          	<td>
...
<table align="center" cellpadding="0" cellspacing="0" class="admin_table font03">
  <tr> 
    <td>		 
              ...
              if(currentpage>1){
             %>
              <a href="MylistGrade.jsp?action=Mylistgrade&curpage=1">首页</a>
             <% 
              }else{
              %>
                首页
             ...
             <% 
              if(currentpage!=1){
             %>
              <a href="MylistGrade.jsp?action=Mylistgrade&currentpage=<%=currentpage-1 %>">上一页</a>
             <% 
              }else{
              %>
                上一页
             ...
             %>
              <a href="MylistGrade.jsp?action=Mylistgrade&curpage=<%=currentpage+1 %>">下一页</a>
             <% 
              }else{
              %>
               下一页
             ...
             <% 
              ...
              %>
                 <a href="MylistGrade.jsp?action=Mylistgrade&curpage=<%=totalpage %>">尾页</a>
             <% 
              }
             %>		  
   </td>
