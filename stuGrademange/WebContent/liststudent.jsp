...
<script>
		...
		function check(){
			...
			//后续查询做相应的修改
			window.location.href="stulist.jsp?action=search&text="+text;
		}
</script>
<body>
          ...
          <tr>
			...
			<!-- 列表 start -->
          	...
          	<tbody>
				...
				<td>
	        	<a href="editstudent.jsp?studentid=<%=d.get("studentid")%>">编辑</a><b>|</b>
	        	<a href="deletestudent.jsp?studentid=<%=d.get("studentid")%>">删除</a>
	        	</td>
	        </tr>
			<% 
				}
...
<table align="center" cellpadding="0" cellspacing="0" class="admin_table font03">
  <tr> 
    <td>		 
              ...
              if(currentpage>1){
             %>
              <a href="stulist.jsp?action=liststudent&curpage=1">首页</a>
             <% 
              }else{
              %>
                首页
             ...
             <% 
              if(currentpage!=1){
             %>
              <a href="stulist.jsp?action=liststudent&currentpage=<%=currentpage-1 %>">上一页</a>
             <% 
              }else{
              %>
                上一页
             ...
             %>
              <a href="stulist.jsp?action=liststudent&curpage=<%=currentpage+1 %>">下一页</a>
             <% 
              }else{
              %>
               下一页
             ...
             <% 
              ...
              %>
                 <a href="stulist.jsp?action=liststudent&curpage=<%=totalpage %>">尾页</a>
             <% 
              }
             %>	
   </td>
