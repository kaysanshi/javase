		...
		<div class="formbody">
			...
			<ul class="forminfo">
				<li><label>商品名称<b>*</b> </label> <input name="name" type="text"
					class="dfinput" value="请填写商品名称" style="width:518px;" /></li>
				...
				<li><label>商品封面<b>*</b> </label> <input type="text"
					class="dfinput" style="width:278px;" id="filepath" name="photo" value="" />
				...
				<li><label>商品价格<b>*</b> </label> <input name="price" type="text"
					class="dfinput" value="请填写商品价格" style="width:278px;" /></li>

				<li><label>市场价格<b>*</b> </label> <input name="markprice" type="text"
					class="dfinput" value="请填写商品市场价格" style="width:278px;" /></li>

				<li><label>商品数量<b>*</b> </label> <input name="quality" type="text"
					class="dfinput" value="请填写商品数量" style="width:278px;" /></li>
				...
				<li> <textarea id="content7"
						name="content" style="width:700px;height:250px;"></textarea>
						<script type="text/javascript">
