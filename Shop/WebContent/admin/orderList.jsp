...
<body>
	...
	<div class="formbody">
		...
		<div class="tools">
			<ul class="toolbar">
				<li><span><input name="" type="checkbox" value=""
						checked="checked" />&nbsp;</span>全选</li>
		...
		<c:forEach var="order"  items="${orderlist}">
			<div class="formtitle">
				<span>订单编号：${order.orderid}
				&nbsp;&nbsp;合计￥${order.totalprice}&nbsp;&nbsp; <c:choose>
			...
			<div class="toolsli">
				<table class="imgtable">
					<thead>
						<tr>
							<th><input name="" type="checkbox" value=""
								checked="checked" /></th>
							<th colspan="3">订单编号&nbsp;&nbsp;共10件商品&nbsp;&nbsp;合计￥120.5&nbsp;&nbsp;交易成功</th>
						</tr>
					</thead>
					...
					<c:forEach var="orderitem" items="${order.orderItemList}">
						<tr>
							<td class="imgtd"><img src="<c:url value='/${orderitem.product.photo}'/>" />
							</td>
							<td><a href="#">${orderitem.product.name} </a>
							</td>
	...
	<div class="pagin">
		<div class="message">
			共<i class="blue">12</i>条记录，当前显示第&nbsp;<i class="blue">2&nbsp;</i>页
		</div>
		<ul class="paginList">
