...
<tr><td>发布日期：</td><td><input type="text" name="publishedDate" onclick="J.calendar.get();"/></td></tr>
<tr><td>内容：</td><td><textarea name="content" rows="5" cols="50"></textarea></td></tr>
<tr><td colspan="2" ><input type="submit" value="发布新闻"/></td></tr>
