...
<html>
  ...
  <div align="center" >
  	<h1>实名认证</h1><hr>
  	<form action="${pageContext.request.contextPath }/CertificationServlet" method="POST" onsubmit="return checkForm()">
  		<table>
  			<tr>
  				<td>用户名:</td>
  				<td><input type="text" name="username" value="${sessionScope.user}"/></td>
  			...
  			<tr>
  				<td>学号:</td>
  				<td><input type="text" name="stunumber" value="${param.stunumber }"/></td>
  				<td id="tellphone_msg"></td>
  			</tr>
  			<tr>
  				<td>电话:</td>
