    ...
    <div class="container">
        ...
        <div id="navbar" class="">
            ...
            <ul class="nav navbar-nav">   
                <li class="active"><a href="/memo/add.jsp">新建</a></li>
    ...
    <div class="row row-centered">
        <div class="well col-md-9 col-centered">
            <div class="add">
                ...
                <br/>
                <button type="button" class="btn btn-success btn-block" id="add-btn">提交</button>
            </div>
        </div>
    </div>
</div>
        ...
        $('#add-btn').click(function () {
            if ($('#title').val() == "" || $('#content').val() == "" || $('#date').val() == "") {
                ...
                $.ajax({
                    url:'/memo/rd_add',
                    type:'POST',
                    data:{title:ttitle,content:tcontent,date:tdate},
                    dataType:'json',
