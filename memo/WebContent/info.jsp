        ...
        <div class="well col-md-9 col-centered">
            <div class="add">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" disabled="disabled" value="${record.title }">
                </div>
                <br/>
                <div class="input-group">
                    <span class="input-group-btn">
                    ...
                    <input type="text" class="form-control" id="content" name="content" disabled="disabled" value="${record.text }">
                </div>
                <br/>
                <div class="input-group">
                    <span class="input-group-btn">
                    ...
                    <input type="text" class="form-control" id="date" name="date" disabled="disabled" value="${record.time }">
                </div>
                <br/>
                <button type="button" class="btn btn-success btn-block" id="delbtn" url="${record.id }">删除</button>
            </div>
        </div>
    </div>
</div>
