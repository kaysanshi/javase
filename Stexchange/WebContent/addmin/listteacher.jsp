...
$("#teacherSearchBtn").click(function(){
		...
		$.ajax({
			...
			data:$("#TeacherSearchForm").serialize(),
...
<body>
		 <!-- 搜素区域 --> 
	   <form id="TeacherSearchForm" method="post" action="">
	   <table align="center" width="100%" border="0" cellpadding="0" 
                             cellspacing="0" class="biao">	
           <tr>
			 <td class="neirong">
			   教师名：<input type="text" name="name" id="teachername" value="${realname}" style="width:30%">
			   
			   <input type="hidden" name="curpage" value="">
			   
			   <a href="javascript:void(0);" id="teacherSearchBtn" class="btn-green">搜&nbsp;索</a>
       ...
       <table align="center" width="100%" border="0" cellpadding="0" 
				  ...
				  <tr>
					...
					<td class="neirong">
					   <a href="javascript:Del('DeleteTeacherServlet?teacherid=${r.id}','post')">删除</a>
						<a href="javascript:Edit('EditTeacherServlet?teacherid=${r.id}','post')">编辑</a>
	...
	<div align="center" style="font-size:14px">
		<c:set var="url" value="${pageContext.request.contextPath}/addmin/ListTeacherServlet"/>
