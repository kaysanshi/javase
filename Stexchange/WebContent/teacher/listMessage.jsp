...
//删除方法
function ajaxDelReply(url,method){	
	alert(22212);
	$.ajax({
		type:method,
		url:url,
...
<form id="MessageSearchForm" method="post" action="">
	   <table align="center" width="100%" border="0" cellpadding="0" 
           ...
           <tr>
			 <td class="neirong">
			  消息名：<input type="text" name="messagetitle" value="${title}" style="width:30%">
 ...
 <table align="center" width="100%" border="0" cellpadding="0" 
				  ...
				  <tr>
					...
					<td class="neirong">${r.studentid}</td>
					<td class="neirong">
					<a href="javascript:sendAjaxReply('ReplyServlet?msid=${r.id}','post');">回复</a>
					<a href="javascript:ajaxDelReply('DelMessageServlet?msid=${r.id}','post');">删除</a>
					</td>
	              </tr>
				 </c:forEach>
		</table>
		<div align="center" style="font-size:14px">
		<c:set var="url" value="${pageContext.request.contextPath}/teacher/ListMessageServlet"/>
