...
/**
 * Servlet implementation class GetVideoListServlet
 */
@WebServlet(name = "VideoListServlet", description = "视频列表", urlPatterns = { "/VideoListServlet" })
public class GetVideoListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List  list=service.getListvideo();
